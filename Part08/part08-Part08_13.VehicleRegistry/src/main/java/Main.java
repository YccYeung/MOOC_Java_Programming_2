...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(vr.add(new LicensePlate("FI", "BBB-222"), "Pekka"));
        System.out.println(vr.add (new LicensePlate("FI", "CCC-333"), "Jukka"));
        System.out.println(vr.add (new LicensePlate("FI", "DDD-444"), "Jukka"));
